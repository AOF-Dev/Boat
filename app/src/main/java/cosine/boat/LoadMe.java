...
public class LoadMe {
    ...
    public static int exec(LauncherConfig config) {
        try {
			...
			String runtimePath = "/data/data/com.mio.boat/app_runtime";
            ...
            args.add("--width");
            args.add(Integer.toString(MyApplication.getCurrentActivity().getResources().getDisplayMetrics().widthPixels));
            args.add("--height");
            args.add(Integer.toString(MyApplication.getCurrentActivity().getResources().getDisplayMetrics().heightPixels));
